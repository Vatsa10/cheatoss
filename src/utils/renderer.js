...
// Listen for responses - REMOVED: This is handled in CheatossApp.js to avoid duplicates
...
const cheatossApp = document.querySelector('cheatoss-app');
...
const cheddar = {
    ...
    getCurrentView: () => cheatossApp.currentView,
    getLayoutMode: () => cheatossApp.layoutMode,

    // Status and response functions
    setStatus: text => cheatossApp.setStatus(text),
    setResponse: response => cheatossApp.setResponse(response),
